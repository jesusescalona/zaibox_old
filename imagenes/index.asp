...
cssdropdown.startchrome("chromemenu")
  ...
  <tr>
    <td colspan="2" align="center" style="background-repeat:no-repeat"><table border="0">
      ...
      <tr>
        <td valign="top"><img src="imagenes/pse.png" alt="Pagos PSE" width="148" height="60" border="0" usemap="#Map11"></td>
        <td valign="top"><img src="imagenes/paypal.png" alt="Pagos PSE" width="145" height="60" border="0" usemap="#Map12"></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
...
<map name="Map11">
  <area shape="rect" coords="2,1,150,62" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=UB9MP2QMKX87A" target="_blank">
</map>

<map name="Map12">
  <area shape="rect" coords="1,1,151,60" href="https://www.psepagos.co/PSEHostingUI/ShowTicketOffice.aspx?ID=1482" target="_blank">
</map>
</body>
</html>
