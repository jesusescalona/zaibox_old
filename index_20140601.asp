  ...
  <tr>
    <td colspan="2" align="center" style="background-repeat:no-repeat"><table border="0">
            ...
            <tr align="right">
              <td valign="top"><table width="100" border="0">
                ...
                <tr>
                  ...
                  <td class="letrasLCAster"><img src="imagenes/B_Ecuador.jpg" alt="Ecuador" width="60" height="34" border="1"></td>
                  </tr>
              </table></td>
              </tr>
            <tr align="right">
      ...
      <tr>
        ...
        <img src="imagenes/S_facebook.png" width="25" height="25" alt="Facebook"><img src="imagenes/S_twitter.png" width="25" height="25" alt="Twitter"></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
