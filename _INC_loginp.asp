...
<table align="right" border="0" cellspacing="0" cellpadding="0" >
  <tr>
    ...
    <td><div align="left">
      <input name="usuario" type="text" class="txtCajas" placeholder="Escribe tu casillero ZB#-###" style="background-color:#FFD" />
    </div></tr>
  <tr>
    <td colspan="2"></td>
    </tr>
  ...
  <tr>
    <td colspan="2" align="right" class="<%= texto3%> "><a href="javascript:window.open('http://zaicargo.controlbox.net/webcasilleros/oc.asp','RecuperarContra','width=400,height=400,scrollbars=no,toolbar=no')">Olvido su clave?</a>
